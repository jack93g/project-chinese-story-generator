...
EVAL_FIXTURES: list[EvalFixture] = [
    EvalFixture(
        ...
        vocabulary_snapshot=[
            {"id": 9001, "writing": "你好", "reading": "nǐhǎo", "definition_en": "hello"},
            {"id": 9002, "writing": "谢谢", "reading": "xièxie", "definition_en": "thank you"},
            {"id": 9003, "writing": "朋友", "reading": "péngyou", "definition_en": "friend"},
    ...
    EvalFixture(
        ...
        vocabulary_snapshot=[
            {"id": 9010, "writing": "经验", "reading": "jīngyàn", "definition_en": "experience"},
            {"id": 9011, "writing": "环境", "reading": "huánjìng", "definition_en": "environment"},
            {"id": 9012, "writing": "建议", "reading": "jiànyì", "definition_en": "suggestion; to suggest"},
            {"id": 9013, "writing": "讨论", "reading": "tǎolùn", "definition_en": "to discuss"},
            {"id": 9014, "writing": "机会", "reading": "jīhuì", "definition_en": "opportunity"},
            {"id": 9015, "writing": "决定", "reading": "juédìng", "definition_en": "decision; to decide"},
        ],
    ),
    EvalFixture(
        name="hsk6_advanced",
        ...
        target_vocabulary_count=5,
        vocabulary_snapshot=[
            {"id": 9020, "writing": "战略", "reading": "zhànlüè", "definition_en": "strategy"},
            {"id": 9021, "writing": "潜力", "reading": "qiánlì", "definition_en": "potential"},
            {"id": 9022, "writing": "谈判", "reading": "tánpàn", "definition_en": "negotiation"},
            {"id": 9023, "writing": "妥协", "reading": "tuǒxié", "definition_en": "compromise"},
            {"id": 9024, "writing": "权衡", "reading": "quánhéng", "definition_en": "to weigh (pros and cons)"},
        ],
    ),
    EvalFixture(
        ...
        target_vocabulary_count=5,
        vocabulary_snapshot=[
            {"id": 9030, "writing": "银行", "reading": "yínháng", "definition_en": "bank"},
            {"id": 9031, "writing": "长", "reading": "zhǎng / cháng", "definition_en": "to grow (zhǎng) / long (cháng)"},
            {"id": 9032, "writing": "还", "reading": "hái / huán", "definition_en": "still (hái) / to return (huán)"},
            {"id": 9033, "writing": "重", "reading": "zhòng / chóng", "definition_en": "heavy (zhòng) / to repeat (chóng)"},
            {"id": 9034, "writing": "差", "reading": "chà / chāi / chā", "definition_en": "poor/lacking (chà) / dispatch (chāi) / difference (chā)"},
        ],
    ),
    EvalFixture(
    ...
    EvalFixture(
        ...
        vocabulary_snapshot=[
            ...
            {"id": 9052, "writing": "朋友", "reading": "péngyou", "definition_en": "friend"},
            {"id": 9053, "writing": "邂逅", "reading": "xièhòu", "definition_en": "a chance encounter (literary)"},
            {"id": 9054, "writing": "踌躇", "reading": "chóuchú", "definition_en": "to hesitate (literary)"},
        ],
    ),
    EvalFixture(
        ...
        vocabulary_snapshot=[
            {"id": 9060, "writing": "旅行", "reading": "lǚxíng", "definition_en": "travel"},
            {"id": 9061, "writing": "计划", "reading": "jìhuà", "definition_en": "plan"},
            {"id": 9062, "writing": "天气", "reading": "tiānqì", "definition_en": "weather"},
            {"id": 9063, "writing": "行李", "reading": "xínglǐ", "definition_en": "luggage"},
            {"id": 9064, "writing": "机场", "reading": "jīchǎng", "definition_en": "airport"},
            {"id": 9065, "writing": "护照", "reading": "hùzhào", "definition_en": "passport"},
            {"id": 9066, "writing": "预订", "reading": "yùdìng", "definition_en": "to book/reserve"},
            {"id": 9067, "writing": "延误", "reading": "yánwù", "definition_en": "delay"},
            {"id": 9068, "writing": "导游", "reading": "dǎoyóu", "definition_en": "tour guide"},
            {"id": 9069, "writing": "风景", "reading": "fēngjǐng", "definition_en": "scenery"},
            {"id": 9070, "writing": "纪念品", "reading": "jìniànpǐn", "definition_en": "souvenir"},
            {"id": 9071, "writing": "预算", "reading": "yùsuàn", "definition_en": "budget"},
        ],
