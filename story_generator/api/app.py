...
from story_generator.api.security import require_api_key
...
def create_app() -> FastAPI:
    ...
    # API-key dependency doesn't cover, and a browser can't send the header
    # to them, so they're disabled rather than left public.
    app = FastAPI(
